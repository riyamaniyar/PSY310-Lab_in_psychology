...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\RIYA MANIYAR\\OneDrive\\Desktop\\Lab in Psycholgy\\stroop task\\untitled_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text_2 = visual.TextStim(win=win, name='text_2',
        text="Press the 'b' key for blue font colour\nPress the 'r' key for red font colour",
        font='Arial',
    ...
    if inst.maxDurationReached:
        routineTimer.addTime(-inst.maxDuration)
    elif inst.forceEnded:
        routineTimer.reset()
    else:
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('stroop task conditions.xlsx'), 
        seed=None, 
    )
        ...
        while continueRoutine:
            ...
            if key_resp.status == STARTED and not waitOnFlip:
                ...
                if len(_key_resp_allKeys):
                    ...
                    # was this correct?
                    if (key_resp.keys == str(Correct_Re)) or (key_resp.keys == Correct_Re):
                        key_resp.corr = 1
                    else:
                        key_resp.corr = 0
